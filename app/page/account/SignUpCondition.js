...
const SignUp = ({navigation}) => {
    ...
    return (
        <Container>
            ...
            <Wrapper>
                <ContractTitle>이용 약관</ContractTitle>
                <ContractText>
{`제1조 (목적)\n
본 약관은 안가구(이하 '회사')가 고도 사이트(이하 ‘사이트’)를 통하여 인터넷상에서 제공하는 서비스(이하 ‘서비스’)를 이용하는 고객 (이하 '고객')간의 권리와 의무 및 책임 등 기타 제반사항을 규정함을 목적으로 합니다.\n
\n
제2조 (용어의 정의)\n
...
\n
부칙 (시행일)\n
본 약관은 2021년 6월 1일부터 적용됩니다.\n`}

                </ContractText>    
                
            </Wrapper>
            <AgreeButton buttonColor="#35BCD6" textColor="#ffffff" onPress={() => {navigation.navigate("SignUp")}}>약관에 동의합니다.</AgreeButton>
        </Container>
    )
}
...
const ContractText = styled(Text)`
    ...
    margin: 20px;
`
const AgreeButton = styled(ButtonWithText)`
